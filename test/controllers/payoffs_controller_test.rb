...
class PayoffsControllerTest < ActionController::TestCase
  ...
  test "should create payoff" do
    assert_difference('Payoff.count') do
      post :create, payoff: { name: @payoff.name, payoff: @payoff.payoff, project_id: @payoff.project_id, url: @payoff.url }
    end
  ...
  test "should update payoff" do
    patch :update, id: @payoff, payoff: { name: @payoff.name, payoff: @payoff.payoff, project_id: @payoff.project_id, url: @payoff.url }
    assert_redirected_to payoff_path(assigns(:payoff))
  end
